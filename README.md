# ⛓ OpenHash Jeju Province Node

![Layer](https://img.shields.io/badge/Layer-3-purple)
...
|---|---|
| Node ID | `KR-JEJU` |
| Layer | L3 — Jeju Province |
| Endpoint | `https://nounweb.github.io/openhash-L3-jeju` |
...
curl -X POST \
  ...
  https://api.github.com/repos/nounweb/openhash-L3-jeju/dispatches \
  -d '{
